...
from idrid_data_generator import IDRID_Loader as DataGenerator
...
## Path
model_path = '/scratch/cse/btech/cs1170354/BTP2/weights/idrid_weights.h5' # Saving location
log_path = '/scratch/cse/btech/cs1170354/BTP2/logs/idrid_weights'
weights_paths = []
...
folder_path = "/scratch/cse/btech/cs1170354/BTP2/Data/IDRID_dataset"
...
if mode == 'seg':
    model = att_unet
    metrics = [uniclass_dice_coeff_0, uniclass_dice_coeff_1, uniclass_dice_coeff_2, uniclass_dice_coeff_3, uniclass_dice_coeff_4, multiclass_dice_coeff]
    # losses = multiclass_dice_loss(loss_scales=[2., 2., 1., 1., 1.])
...
# Data generators
train_generator = DataGenerator(folder_path, 'a. Training Set', image_size, batch_size, mode='seg', target_classes=target_classes
                            , filter_classes=[], augment=True)
val_generator = DataGenerator(folder_path, 'b. Testing Set', image_size, batch_size, mode='seg', target_classes=target_classes
