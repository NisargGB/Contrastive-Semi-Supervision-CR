...
## Path
model_path = '/scratch/cse/btech/cs1170354/BTP2/weights/jsrt/jsrt_weights{epoch:05d}.h5'  # Saving location
log_path = '/scratch/cse/btech/cs1170354/BTP2/logs/jsrt_weights'
weights_paths = []
...
callbacks = [ModelCheckpoint(model_path, save_weights_only=True, period=3),
